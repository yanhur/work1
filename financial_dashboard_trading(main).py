...
choices = ['台積電: 2023.04.17 至 2025.04.16', '大台指期貨: 2020.03.23 至 2025.03.14', '小台指期貨: 2020.03.02 至 2025.03.14', '華碩2023.04.17 至 2025.04.16', '堤維西2020.1.2 至 2024.4.12']
choice = st.selectbox('選擇金融商品', choices, index=0)
##### 读取Pickle文件
if choice == choices[0] :         ##'台積電: 2022.1.1 至 2024.4.9':
    df_original = load_data('kbars_1D_2330_2023-04-2025-04.pkl')
...
if choice == choices[1] :                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('kbars_1D_TXF_2020-2025.pkl')
    product_name = '大台指期貨'
if choice == choices[2] :                              ##'小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('kbars_1D_MXF_2023-2025.pkl')
    product_name = '小台指期貨'
if choice == choices[3] :                                           ##'英業達2020.1.2 至 2024.4.12':
    df_original = load_data('kbars_1D_2357_2023-04-2025-04.pkl')
    product_name = '華碩2357'
...
if choice == choices[1] :                                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
    start_date = st.text_input('輸入開始日期(日期格式: 2020-03-23), 區間:2020-03-23 至 2025-03-14', '2020-03-23')
    end_date = st.text_input('輸入結束日期 (日期格式: 2025-03-14), 區間:2020-03-23 至 2025-03-14', '2025-03-14')
if choice == choices[2] :                                               ##'小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    start_date = st.text_input('輸入開始日期(日期格式: 2020-03-02), 區間:2020-03-02 至 2025-03-14', '2020-03-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 2025-03-14), 區間:2020-03-02 至 2025-03-14', '2025-03-14')
if choice == choices[3] :                                                ##'英業達2020.1.2 至 2024.4.12':
    start_date = st.text_input('輸入開始日期(日期格式: 2023-04-17), 區間:2023-04-17 至 2025-04-16', '2023-04-17')
    end_date = st.text_input('輸入結束日期 (日期格式: 2025-04-16), 區間:2023-04-17 至 2025-04-16', '2025-04-16')
if choice == choices[4] :                                                             ##'堤維西2020.1.2 至 2024.4.12':
